...
START_TEST(int_sprintf_20) {
  ...
  char test_your[1024] = "";
  ck_assert_int_eq(sprintf(test_original, "patj% 8E dslkj", INFINITY),
                   s21_sprintf(test_your, "patj% 8E dslkj", INFINITY));
}
END_TEST
...
START_TEST(int_sprintf_21) {
  char test_original[1024] = "";
  char test_your[1024] = "";
  ck_assert_int_eq(sprintf(test_original, "saeflkahj% 8e dslkj", INFINITY),
                   s21_sprintf(test_your, "saeflkahj% 8e dslkj", INFINITY));
}
END_TEST
...
Suite *test_sprintf() {
  ...
  tcase_add_test(tcase_sprintf, int_sprintf_20);
  tcase_add_test(tcase_sprintf, int_sprintf_21);
  tcase_add_test(tcase_sprintf, sprintf_i_3036);
