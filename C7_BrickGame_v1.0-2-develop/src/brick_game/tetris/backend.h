 ...
 */
typedef enum { TLEFT, TRIGHT, TUP, TDOWN, TDROP, TPAUSE, TEND, TNONE } Tmove;
...
/**
 * @brief Проверка на достижение верхней границы поля -> конец игры
 * @param game Структура игры
 * @return true || false
 */
...
/**
 * @brief Падение тетрамино до соприкосновения
 * @param game Структура игры
 */
